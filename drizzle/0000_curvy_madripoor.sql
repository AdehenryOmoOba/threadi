...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "comments_replies" ADD CONSTRAINT "comments_replies_author_users_uuid_fk" FOREIGN KEY ("author") REFERENCES "users"("uuid") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "communities" ADD CONSTRAINT "communities_created_by_users_uuid_fk" FOREIGN KEY ("created_by") REFERENCES "users"("uuid") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "threadis" ADD CONSTRAINT "threadis_author_users_uuid_fk" FOREIGN KEY ("author") REFERENCES "users"("uuid") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "threadis" ADD CONSTRAINT "threadis_community_communities_uuid_fk" FOREIGN KEY ("community") REFERENCES "communities"("uuid") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
